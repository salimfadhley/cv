...
\begin{document}
    ...
    \begin{resume}
        ...
        {\sl Programming Languages:} Python, Scala, JavaScript, Groovy, Java, \LaTeX \\
        {\sl Operations Technologies:} Jenkins, Ansible, OpenShift, Travis, Ansible, GitHub, BitBucket, Linux, SQL Databases, SBT, \\
