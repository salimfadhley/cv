...
\begin{document}
    ...
    \begin{resume}
        ...
        {\sl Python, Data, DevOps Engineer} - \textbf{Diamond Industry Start-up} \hfill Octomber 2018 - December 2018 \\
         ...
         I'm working as a principal engineer for a data-science project within a diamond-industry start-up.

         I am helping build the core libraries, AWS infrastructure. I have created the build, development and and CI tooling.
        ...
        brings together Atlassian Stack + Jenkins. I maintain the
        ...
        \begin{itemize}
            \item Performing improvised comedy
            \item Cycling
            \item Running
        \end{itemize}
